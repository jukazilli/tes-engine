...
| backend/organizations         | `libs/backend/organizations`         | `scope:backend`, `type:feature`, `platform:node`               | Organizacoes e RBAC   | `@tes-engine/backend/organizations`         |
| backend/companies             | `libs/backend/companies`             | `scope:backend`, `type:feature`, `platform:node`               | Empresas e filiais    | `@tes-engine/backend/companies`             |
| backend/protheus-environments | `libs/backend/protheus-environments` | `scope:backend`, `type:feature`, `platform:node`               | Ambientes Protheus    | `@tes-engine/backend/protheus-environments` |
...
Projects, Files, Fiscal Documents, Processing, Rules, Scenarios, Protheus Matching, Review,
Approval, Exports e Audit.
