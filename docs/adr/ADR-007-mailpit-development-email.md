...
Fluxos futuros terao confirmacao de e-mail e notificacoes. O Prompt 02 exige captura local sem envio real.
...
E-mails futuros poderao ser testados localmente sem destinatarios externos. Producao deve usar provedor transacional real.
